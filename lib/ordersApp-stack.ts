...
export class OrdersAppStack extends cdk.Stack {
  ...
  constructor(scope: Construct, id: string, props: OrdersAppStackProps) {
    ...
    const writeThottlerEventsMetric = ordersDdb.metric("WriteThrottleEvents", {
      period: cdk.Duration.minutes(2),
      statistic: "SampleCount",
      unit: cw.Unit.COUNT,
    });

    writeThottlerEventsMetric.createAlarm(this, "WriteThottlerEventsAlarm", {
      alarmName: "WriteThottlerEvents",
    ...
    const productNotFoundAlarm = productNotFoundMetricFilter
      ...
      .createAlarm(this, "ProductNotFoundAlarm", {
        ...
        alarmDescription: "Some product was not found while creating an order",
        evaluationPeriods: 1,
        threshold: 2,
        actionsEnabled: true,
        comparisonOperator:
    ...
    orderAlarmsTopics.addSubscription(
      new subs.EmailSubscription("brunocruzdeoliveira@gmail.com"),
    );
    productNotFoundAlarm.addAlarmAction(
      new cw_actions.SnsAction(orderAlarmsTopics),
    );
