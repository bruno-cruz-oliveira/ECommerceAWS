...
export async function handler(
  ...
  console.log(
    `API Request ID: ${apiRequestId} - LambdaRequestId: ${lambdaRequestId}`,
  );
  ...
  if (method === "GET") {
    ...
    if (products.length === orderRequest.productIds.length) {
      ...
      console.log(
        `Order created event send - OrderId: ${orderCreated.sk} - MessageId: ${eventResult.MessageId}`,
      );
    ...
    try {
      ...
      console.log(
        `Order deleted event send - OrderId: ${orderDelete.sk} - MessageId: ${eventResult.MessageId}`,
      );
